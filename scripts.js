let cardContents = [
    ...
    },
    {
        ...
        question: `Wie dick müsste der Spinnwebfaden sein,
        ...
        infoText: `Spinnwebfäden sind das belastbarste Material, das man aus der Natur kennt.
    ...
    },
    {
        ...
        question: `Wie viele Züge sind höchstens
                  ...
                  zu lösen?`,
        answers: {
                    wrongAnswers: ['30', '14', 'Weiß man nicht'],
                    correctAnswer: '20'
                },
    ...
    },
    {
        ...
        winTexts: ["Du hast alle Fragen richtig beantwortet und damit klar bewiesen, dass du echtes Faktenwissen besitzt!", "Nicht schlecht! Das muss dir erst mal jemand nachmachen!", "Das ist eine solide Leistung", "Okay, du hattest mal einen schlechten Tag. Haben wir alle mal!"]
    }
];
let i = 0;
let randomNumber = 0;
...
let clickAnsw = function clickAnswer(event) {
    ...
    if(document.querySelector('.card').classList.contains('answered')) {
        ...
        if(event.target.classList.contains('correct')) {
            document.querySelector('#soundCorrect').play();
            event.target.style.backgroundColor = 'green'
            event.target.style.color = 'white';
            correctlyAnswered++;
        }else {
            document.querySelector('#soundWrong').play();
...
function choosewinTexts() {
    if(correctlyAnswered <= 3) {
        ...
        document.querySelector('#soundHooray').play();
...
function playAudio(trueFalse) {
    console.log(trueFalse);
    document.querySelector('audio source').src = '';
    if(trueFalse) {
        document.querySelector('audio source').src = './sounds/correct.mp3';
    }else if(!trueFalse) {
        document.querySelector('audio source').src = './sounds/wrong.mp3'
    }
    document.querySelector('audio').play();
}

function stopAudio() {
    document.querySelector('#soundCorrect').pause();
    document.querySelector('#soundCorrect').currentTime = 0;
    document.querySelector('#soundWrong').pause();
    document.querySelector('#soundWrong').currentTime = 0;
}